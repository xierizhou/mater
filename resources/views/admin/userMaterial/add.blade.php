@extends('admin.app')
@section('title', '添加用户权限')
@section('content')
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="POST" action="{{ url('admin/user_material') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text"  name="current" required=""  autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label"><span class="x-red">*</span>每日刷新量</label>
                        <div class="layui-input-inline">
                            <input type="text"  name="total" required=""  autocomplete="off" class="layui-input"></div>
                    </div>

                    <div class="layui-form-item">
                        <label class="layui-form-label"><span class="x-red">*</span>每日是否刷新</label>
                        <div class="layui-input-block">
                            <input type="radio" name="is_daily_reset" value="1" title="是" checked="">
                            <input type="radio" name="is_daily_reset" value="0" title="否">
                        </div>
                    </div>
