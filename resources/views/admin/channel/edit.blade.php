            ...
            <div class="layui-row">
                <form class="layui-form" method="POST" action="{{ url('admin/channel') }}/{{ $data->id }}">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" value="{{ $data->username }}" name="username"  autocomplete="off" class="layui-input"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" value="{{ $data->password }}" name="password"  autocomplete="off" class="layui-input"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="state" lay-filter="state">
                                ...
                                <option {{ $data->state ==2?"selected":"" }} value="2">过期</option>
                            </select>
                        </div>
                    </div>
