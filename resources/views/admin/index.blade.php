...
@section('content')
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="./index.html">管理后台 v1.0</a></div>
            <div class="left_open">
        ...
        <div class="left-nav">
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="文件素材管理">&#xe6b8;</i>
                            <cite>文件素材管理</cite>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="价格管理">&#xe6b8;</i>
                            <cite>价格管理</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('单网价格','{{ url('admin/material_price') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>单网价格</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('套餐价格','{{ url('admin/user_material') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>套餐管理</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('会员列表','{{ url('admin/user') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>会员列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('下载权限','{{ url('admin/user_material') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>下载权限</cite></a>
                            </li>
                        </ul>
